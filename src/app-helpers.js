...
export function useCommitsFetcher({username, repo, sha, path, page, pageSize}) {
  return useLoader(
    async () => getCommits(username, repo, sha, path, page, pageSize),
    [repo, sha, path],
  );
}
...
export function getUrlParams() {
  ...
  return [username, username + '/' + reponame, sha, '/' + paths.join('/')];
}
